...
<link href="//cdn-images.mailchimp.com/embedcode/horizontal-slim-10_7.css" rel="stylesheet" type="text/css">
			<style type="text/css">
				#mc_embed_signup{clear:left; font:14px Helvetica,Arial,sans-serif; width:100%; display: table-cell;
    vertical-align: middle; }
				#mc_embed_signup .button{background-color:#ED4956; -webkit-appearance: none;}
			...
			<form action="https://the-accounts.us18.list-manage.com/subscribe/post?u=90ce6f39cf21c630ec1b3176d&amp;id=beec86d5f4" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
				...
				<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="Signup For Daily Discoveries" required>
